...
export function FinalResult({ result, onRestart, exportResult = exportResultImage }: { result: FinalRankingSuccessPayload; onRestart: () => void; exportResult?: ResultImageExporter }) {
